...
static void odx_intro_screen(void) {
	...
	FILE *f;
	odx_video_flip();
	sprintf(name,"/fat20a2/hda2/GAME/mame4all/skins/splash.bmp");
	f=fopen(name,"rb");
	if (f) {
	...
	sprintf(name,"/fat20a2/hda2/GAME/mame4all/skins/menu.bmp");
	f=fopen(name,"rb");
	if (f) {
...
int main (int argc, char **argv)
{
	...
	gethomedir(mamedir,"/fat20a2/hda2/GAME/mame4all");
	strcpy(romdir,"/fat20a2/hda2/GAME/mame4all/roms");
