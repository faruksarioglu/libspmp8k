...
void get_rom_sample_path (int argc, char **argv, int game_index)
{
	...
	rompath    ="/fat20a2/hda2/GAME/mame4all/roms";// get_string ("directory", "rompath",    NULL, "/fat20a2/hda2/GAME/mame4all/roms;.;./roms");
	samplepath = get_string ("directory", "samplepath", NULL, ".;/fat20a2/hda2/GAME/mame4all/samples");

	/* handle '-romdir' hack. We should get rid of this BW */
	alternate_name ="/fat20a2/hda2/GAME/mame4all/roms";
//	for (i = 1; i < argc; i++)
//	{
...
void parse_cmdline (int argc, char **argv, int game_index)
{
	...
	cheatfile  = get_string ("config", "cheatfile", "cf", "cheat.dat");
 	...
 	history_filename  = get_string ("config", "historyfile", NULL, "/fat20a2/hda2/GAME/mame4all/history.dat");    /* JCK 980917 */

	mameinfo_filename  = get_string ("config", "mameinfofile", NULL, "/fat20a2/hda2/GAME/mame4all/mameinfo.dat");    /* JCK 980917 */

	/* get resolution */
	resolution  = get_string ("config", "resolution", NULL, "auto");

	/* set default subdirectories */
	mdir       = get_string ("directory", "mamepath",   NULL, "/fat20a2/hda2/GAME/mame4all");
	...
	//options.vector_width = 640;//gfx_width;
	//	options.vector_height = 480;//gfx_height;
