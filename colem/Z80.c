...
static void CodesDDCB()
{
  ...
  SET5_B,&&SET5_C,&&SET5_D,&&SET5_E,&&SET5_H,&&SET5_L,&&SET5_xHL,&&SET5_A,&&
  SET6_B,&&SET6_C,&&SET6_D,&&SET6_E,&&SET6_H,&&SET6_L,&&SET6_xHL,&&SET6_A,&&
  SET7_C,&&SET7_D,&&SET7_E,&&SET7_H,&&SET7_L,&&SET7_xHL,&&SET7_A 
  };
...
#define XX IX    
  ...
  CPU.ICount-=CyclesXXCB[I];
	goto *a_jump_table[I];
  //switch(I) {
 RLC_xHL: I=RdZ80(J.W);M_RLC(I);WrZ80(J.W,I);return;
 RRC_xHL: I=RdZ80(J.W);M_RRC(I);WrZ80(J.W,I);return;
 RL_xHL:  I=RdZ80(J.W);M_RL(I);WrZ80(J.W,I);return;
 RR_xHL:  I=RdZ80(J.W);M_RR(I);WrZ80(J.W,I);return;
 SLA_xHL: I=RdZ80(J.W);M_SLA(I);WrZ80(J.W,I);return;
 SRA_xHL: I=RdZ80(J.W);M_SRA(I);WrZ80(J.W,I);return;
 SLL_xHL: I=RdZ80(J.W);M_SLL(I);WrZ80(J.W,I);return;
 SRL_xHL: I=RdZ80(J.W);M_SRL(I);WrZ80(J.W,I);return;

 BIT0_B:  BIT0_C:  BIT0_D:  BIT0_E:
 BIT0_H:  BIT0_L:  BIT0_A:
 BIT0_xHL: I=RdZ80(J.W);M_BIT(0,I);return;
 BIT1_B:  BIT1_C:  BIT1_D:  BIT1_E:
 BIT1_H:  BIT1_L:  BIT1_A:
 BIT1_xHL: I=RdZ80(J.W);M_BIT(1,I);return;
 BIT2_B:  BIT2_C:  BIT2_D:  BIT2_E:
 BIT2_H:  BIT2_L:  BIT2_A:
 BIT2_xHL: I=RdZ80(J.W);M_BIT(2,I);return;
 BIT3_B:  BIT3_C:  BIT3_D:  BIT3_E:
 BIT3_H:  BIT3_L:  BIT3_A:
 BIT3_xHL: I=RdZ80(J.W);M_BIT(3,I);return;
 BIT4_B:  BIT4_C:  BIT4_D:  BIT4_E:
 BIT4_H:  BIT4_L:  BIT4_A:
 BIT4_xHL: I=RdZ80(J.W);M_BIT(4,I);return;
 BIT5_B:  BIT5_C:  BIT5_D:  BIT5_E:
 BIT5_H:  BIT5_L:  BIT5_A:
 BIT5_xHL: I=RdZ80(J.W);M_BIT(5,I);return;
 BIT6_B:  BIT6_C:  BIT6_D:  BIT6_E:
 BIT6_H:  BIT6_L:  BIT6_A:
 BIT6_xHL: I=RdZ80(J.W);M_BIT(6,I);return;
 BIT7_B:  BIT7_C:  BIT7_D:  BIT7_E:
 BIT7_H:  BIT7_L:  BIT7_A:
 BIT7_xHL: I=RdZ80(J.W);M_BIT(7,I);return;

 RES0_xHL: I=RdZ80(J.W);M_RES(0,I);WrZ80(J.W,I);return;
 RES1_xHL: I=RdZ80(J.W);M_RES(1,I);WrZ80(J.W,I);return;   
 RES2_xHL: I=RdZ80(J.W);M_RES(2,I);WrZ80(J.W,I);return;   
 RES3_xHL: I=RdZ80(J.W);M_RES(3,I);WrZ80(J.W,I);return;   
 RES4_xHL: I=RdZ80(J.W);M_RES(4,I);WrZ80(J.W,I);return;   
 RES5_xHL: I=RdZ80(J.W);M_RES(5,I);WrZ80(J.W,I);return;   
 RES6_xHL: I=RdZ80(J.W);M_RES(6,I);WrZ80(J.W,I);return;   
 RES7_xHL: I=RdZ80(J.W);M_RES(7,I);WrZ80(J.W,I);return;   

 SET0_xHL: I=RdZ80(J.W);M_SET(0,I);WrZ80(J.W,I);return;   
 SET1_xHL: I=RdZ80(J.W);M_SET(1,I);WrZ80(J.W,I);return; 
 SET2_xHL: I=RdZ80(J.W);M_SET(2,I);WrZ80(J.W,I);return; 
 SET3_xHL: I=RdZ80(J.W);M_SET(3,I);WrZ80(J.W,I);return; 
 SET4_xHL: I=RdZ80(J.W);M_SET(4,I);WrZ80(J.W,I);return; 
 SET5_xHL: I=RdZ80(J.W);M_SET(5,I);WrZ80(J.W,I);return; 
 SET6_xHL: I=RdZ80(J.W);M_SET(6,I);WrZ80(J.W,I);return; 
 SET7_xHL: I=RdZ80(J.W);M_SET(7,I);WrZ80(J.W,I);return; 
SET7_A:
SET7_L:
SET7_H:
SET7_E:
