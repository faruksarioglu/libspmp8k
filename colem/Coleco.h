...
# define CV_LAST_RENDER       0

# define MAX_PATH           256
# define CV_MAX_SAVE_STATE 2

#define CV_WIDTH  367//;//272
#define CV_HEIGHT 272//;//208

#define SNAP_WIDTH   367
#define SNAP_HEIGHT  272
...
int cv_load_rom(char *FileName, int zip_format);
